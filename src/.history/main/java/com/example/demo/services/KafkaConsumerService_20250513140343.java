...
public void handleFormateurStatusUpdate(String message) {
    try {
        ...
        if (optionalUser.isPresent()) {
            ...
            System.out.println("User ID {} validation status updated to {}" + id + status);
        } else {
            System.out.println("User with ID {} not found in Auth service" + id);
        }
    } catch (Exception e) {
        System.out.println("Failed to process formateur status update" + e);
    }
}
