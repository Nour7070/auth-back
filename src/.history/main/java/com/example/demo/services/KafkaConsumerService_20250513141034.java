...
public class KafkaConsumerService {
    ...
    ObjectMapper objectMapper , FormateurRepository formateurRepository) {
    ...
    import com.example.demo.classes.UserStatus; // Assure-toi que cet import est correct
import com.fasterxml.jackson.core.type.TypeReference;
import org.springframework.kafka.annotation.KafkaListener;
import java.util.Map;
import java.util.Optional;
    ...
    try {
        ...
        if (optionalFormateur.isPresent()) {
            ...
            if ("APPROVED".equalsIgnoreCase(status)) {
                formateur.setStatut(UserStatus.APPROVED);
            } else if ("REJECTED".equalsIgnoreCase(status)) {
                formateur.setStatut(UserStatus.REJECTED);
            }
