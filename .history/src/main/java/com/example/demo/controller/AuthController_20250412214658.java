        ...
        try {
            ...
            if (userType.equalsIgnoreCase("FORMATEUR")) {
                Map<String, String> formateurData = Map.of(
                    "formateurId", registeredUser.getId().toString(),
                    "email", registeredUser.getEmail(),
                    "nomComplet", registeredUser.getFirstName() + " " + registeredUser.getLastName(),
                    "certificats", certificatsStr 
                );
                
                kafkaProducerService.sendFormateurPending((Formateur) registeredUser);
            }
            ...
            if (userType.equalsIgnoreCase("APPRENANT")) {
                Map<String, Object> formateurData = Map.of(
                    ...
                    "certificats", formateur.getCertificats(),
                    "experiences", formateur.getExperiences(),
