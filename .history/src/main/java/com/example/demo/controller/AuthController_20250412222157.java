    ...
    public ResponseEntity<Map<String, Object>> register(
        ...
        try {
            ...
            if (userType.equalsIgnoreCase("FORMATEUR")) {
                Formateur formateur = (Formateur) registeredUser;
                ...
                Map<String, Object> formateurData = Map.of(
                        ...
                        "nomComplet", formateur.getFirstName() + " " + formateur.getLastName(),
                        "certificats", formateur.getCertificats() != null ? formateur.getCertificats() : List.of(),
                        "experiences", formateur.getExperiences() != null ? formateur.getExperiences() : List.of(),
                        "status", formateur.getStatus().name());
