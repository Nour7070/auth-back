...
public ResponseEntity<Map<String, Object>> register(
    ...
    try {
        ...
        String registeredUser = authService.register(user);
        
        // Envoyer les données à Kafka UNIQUEMENT pour les apprenants
        if (userType.equalsIgnoreCase("APPRENANT")) {
            Map<String, String> userData = Map.of(
                ...
                "niveauEtude", niveauEtude != null ? niveauEtude : "",
                "interets", interets != null ? interets : ""
            );
