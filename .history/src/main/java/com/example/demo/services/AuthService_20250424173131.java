...
public class AuthService {
   ...
   @Transactional
    public Map<String, Object> registerUser(
        ...
        if (userType.equalsIgnoreCase("APPRENANT")) {
            Apprenant registeredApprenant = (Formateur) registeredUser;
            ...
            apprenantData.put("status", registeredApprenant.getStatus().name());
            apprenantData.put("certificats", registeredApprenant.getCertificats());
            apprenantData.put("experiences", registeredApprenant.getExperiences());
            
            kafkaProducerService.sendUserRegistration(apprenantData);
        }
