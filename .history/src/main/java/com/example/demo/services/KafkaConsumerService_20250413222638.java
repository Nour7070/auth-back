...
public void handleNewModerator(ConsumerRecord<String, Map<String, String>> record) {
    ...
    String newUserType = ModerateurData.get("userType");
    ...
    User newUser = new User();
    newUser.setUsername(ModerateurData.get("username"));
    newUser.setEmail(email);
    newUser.setPhoto(ModerateurData.get("photo"));
...
public void handleNewModerator(ConsumerRecord<String, Map<String, Object>> record) {
    try {
        ...
        String password = (String) moderateurData.get("password"); // Champ critique ajouté
        ...
        if (existingUser.isPresent()) {
            ...
            // Mettre à jour si nécessaire (exemple)
        ...
        User newUser = new User();
        newUser.setEmail(email);
        newUser.setPassword(password); // Ne pas oublier le mot de passe!
        newUser.setUsername((String) moderateurData.get("username"));
        newUser.setNom((String) moderateurData.get("nom"));
        newUser.setPrenom((String) moderateurData.get("prenom"));
        newUser.setPhoneNumber((String) moderateurData.get("phone"));
        newUser.setPhoto((String) moderateurData.get("photo"));
        newUser.setUserType("MODERATEUR"); // Type hardcodé ou récupéré des données
