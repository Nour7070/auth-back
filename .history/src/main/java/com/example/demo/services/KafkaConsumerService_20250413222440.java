...
public void handleNewModerator(ConsumerRecord<String, Map<String, String>> record) {
    ...
    String firstname = ModerateurData.get("firstname");
    String lastname = ModerateurData.get("lastname");
    String phoneNumber = ModerateurData.get("phoneNumber");
    String password = ModerateurData.get("password");
