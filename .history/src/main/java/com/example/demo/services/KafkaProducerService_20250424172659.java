...
public class KafkaProducerService {
   ...
   public void sendUserRegistration(Apprenant apprenant) {
        ...
        apprenantData.put("email", formateur.getEmail());
        apprenantData.put("prenom", formateur.getFirstName());
        apprenantData.put("nom", formateur.getLastName());
        apprenantData.put("status", formateur.getStatus().name());
        apprenantData.put("certificats", formateur.getCertificats());
        apprenantData.put("experiences", formateur.getExperiences());
