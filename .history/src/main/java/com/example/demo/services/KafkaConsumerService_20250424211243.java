...
public class KafkaConsumerService {
    ...
    @KafkaListener(topics = "new-moderator", groupId = "auth-service-group")
    public void handleNewModerator(String jsonMessage) {
        try {
            Map<String, Object> moderateurData = objectMapper.readValue(jsonMessage, new TypeReference<Map<String, Object>>() {});
