...
public class AuthService {
   ...
   @Transactional
    public Map<String, Object> registerUser(
        ...
        if (userType.equalsIgnoreCase("APPRENANT")) {
            Map<String, String> userData = new HashMap<>(); // Utilisez Map<String, String> au lieu de Map<String, Object>
            userData.put("username", registeredUser.getUsername());
            userData.put("email", registeredUser.getEmail());
            userData.put("photo", photoUrl != null ? photoUrl : "");
            userData.put("userType", registeredUser.getUserType());
            userData.put("firstName", registeredUser.getFirstName());
            userData.put("lastName", registeredUser.getLastName());
            
            kafkaProducerService.sendUserRegistration(userData); // Utilisez le service plutôt que le template directement
        }
