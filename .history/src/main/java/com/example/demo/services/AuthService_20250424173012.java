   ...
   @Transactional
    public Map<String, Object> registerUser(
        ...
        if (userType.equalsIgnoreCase("APPRENANT")) {
            ...
            apprenantData.put("email", registeredFormateur.getEmail());
            apprenantData.put("prenom", registeredFormateur.getFirstName());
            apprenantData.put("nom", registeredFormateur.getLastName());
            apprenantData.put("status", registeredFormateur.getStatus().name());
            apprenantData.put("certificats", registeredFormateur.getCertificats());
            apprenantData.put("experiences", registeredFormateur.getExperiences());
