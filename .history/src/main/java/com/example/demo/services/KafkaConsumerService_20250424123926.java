...
public class KafkaConsumerService {
    ...
    public void handleFormateurValidation(Map<String, Object> response) {
        try {
            ...
            formateur.setStatus(UserStatus.valueOf(status));
            userRepository.save(formateur);
            System.out.println("Statut du formateur %s mis à jour à: %s ", email, status);
            System.out.println(String.format("Statut du formateur %s mis à jour à: %s", email, status));
